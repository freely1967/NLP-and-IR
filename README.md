...
UI is very simple for now but I would like to improve it.

LSI is working as well now!

Will add more Songs soon!

TO START JUST START THE main.py :D 

More Info in OLD_Assignments:
 "Natural Language Processing and Information Retrieval.pdf"
 "HOMEWORK_Natural_Language_Processing"
 "LSI_Document_Elyesa_Duru"
